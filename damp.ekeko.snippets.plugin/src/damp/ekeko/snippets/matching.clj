...
(defn 
  ...
  (fn [snippet]
    ...
    (when 
      ...
      (println "pong: " (astnode/property-descriptor-id (astnode/owner-property snippet-val))))
...
(defn 
  ...
  (when 
    (and 
      (astnode/lstvalue? ast-or-list)
      (= "statements" (astnode/property-descriptor-id (astnode/owner-property ast-or-list))))
    (println "shit hits the fan:" ast-or-list)
    (println (snippet/snippet-bounddirectives-for-node snippet ast-or-list))
    (println (snippet/snippet-var-for-node snippet ast-or-list))
    )
  (let [bounddirectives
