...
(def matched-ast-count (atom 0))
(defn count-match []
  (el/succeeds (do 
                 (swap! matched-ast-count inc)
                 true)))
(defn reset-count-match []
  (reset! matched-ast-count 0))
...
(defn 
  ...
  ([snippet ast-or-list]
    (snippet-node-conditions snippet ast-or-list identity -64))
  ([snippet ast-or-list bounddirectivesfilterf]
    (snippet-node-conditions snippet ast-or-list bounddirectivesfilterf -32))
  ([snippet ast-or-list bounddirectivesfilterf depth]
    (let [bounddirectives
      ...
      (concat conditions-grounding conditions-constraining 
              [`(damp.ekeko.snippets.matching/set-depth ~depth)]))))
